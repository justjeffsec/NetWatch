...
export function KpiCards({ stats }: { stats: Stats | null }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: ArrowUp,
      accentColor: "hsl(128 100% 45%)",
      glowColor: "rgba(0,230,65,0.35)",
      borderColor: "rgba(0,230,65,0.25)",
      testId: "upload",
    },
    {
      label: "Connections",
    ...
    },
    {
      ...
      icon: AlertTriangle,
      accentColor: s.undismissedAlerts > 0 ? "hsl(0 90% 55%)" : "hsl(128 40% 40%)",
      glowColor: s.undismissedAlerts > 0 ? "rgba(255,60,60,0.4)" : "rgba(0,230,65,0.15)",
      borderColor: s.undismissedAlerts > 0 ? "rgba(255,60,60,0.3)" : "rgba(0,230,65,0.15)",
      testId: "alerts",
